...
func newArticle(db *gorm.DB, opts ...gen.DOOption) article {
	...
	_article.IsDraft = field.NewUint(tableName, "is_draft")
	_article.DraftFromID = field.NewInt(tableName, "draft_from_id")
	_article.DraftStatus = field.NewUint(tableName, "draft_status")
	_article.SmallTitle = field.NewString(tableName, "small_title")
	_article.SmallImage = field.NewString(tableName, "small_image")
	_article.Title = field.NewString(tableName, "title")
	_article.BackgroundImage = field.NewString(tableName, "background_image")
	_article.ContentType = field.NewUint(tableName, "content_type")
	_article.Content = field.NewString(tableName, "content")
	_article.ReleaseTime = field.NewTime(tableName, "release_time")
	_article.LastModifyTime = field.NewTime(tableName, "last_modify_time")
	_article.Status = field.NewUint(tableName, "status")
...
type article struct {
	...
	ALL             field.Asterisk
	ID              field.Uint64
	IsDraft         field.Uint   // 草稿: 1=是, 2=否,
	DraftFromID     field.Int    // 草稿来源ID: 0表示需要新建
	DraftStatus     field.Uint   // 状态: 1=已同步, 2=审核中, 3=审核拒绝, 4=审核通过待同步
	SmallTitle      field.String // 简略标题
	SmallImage      field.String // 简略图
	Title           field.String // 标题
	BackgroundImage field.String // 背景图
	ContentType     field.Uint   // 内容类型: 1=txt, 2=html, 3=md,
	Content         field.String // 内容
	ReleaseTime     field.Time   // 发布时间
	LastModifyTime  field.Time   // 上次编辑时间
	Status          field.Uint   // 状态：1=正常, 2=禁用, 3=下架
...
func (a *article) updateTableName(table string) *article {
	...
	a.IsDraft = field.NewUint(table, "is_draft")
	a.DraftFromID = field.NewInt(table, "draft_from_id")
	a.DraftStatus = field.NewUint(table, "draft_status")
	a.SmallTitle = field.NewString(table, "small_title")
	a.SmallImage = field.NewString(table, "small_image")
	a.Title = field.NewString(table, "title")
	a.BackgroundImage = field.NewString(table, "background_image")
	a.ContentType = field.NewUint(table, "content_type")
	a.Content = field.NewString(table, "content")
	a.ReleaseTime = field.NewTime(table, "release_time")
	a.LastModifyTime = field.NewTime(table, "last_modify_time")
...
func (a *article) fillFieldMap() {
	...
	a.fieldMap["draft_from_id"] = a.DraftFromID
	a.fieldMap["draft_status"] = a.DraftStatus
	a.fieldMap["small_title"] = a.SmallTitle
	a.fieldMap["small_image"] = a.SmallImage
	a.fieldMap["title"] = a.Title
	a.fieldMap["background_image"] = a.BackgroundImage
	a.fieldMap["content_type"] = a.ContentType
	a.fieldMap["content"] = a.Content
	a.fieldMap["release_time"] = a.ReleaseTime
	a.fieldMap["last_modify_time"] = a.LastModifyTime
